...
<div class="page-container">
    <div class="form-card">
        <div class="form-header">
            <h1 class="form-title">Edit Instruktur</h1>
            <p class="form-subtitle">Perbarui informasi instruktur</p>
        </div>
        ...
        <form method="POST" action="{{ route('instruktur.update', $instruktur->id_instruktur) }}" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            ...
            <div class="section">
                ...
                <div class="form-group">
                    ...
                    <div class="photo-upload">
                        <div class="avatar-preview">
                            @if($instruktur->foto_profil)
                                <img id="preview" src="{{ $instruktur->foto_profil }}" alt="" style="width:100%; height:100%; object-fit:cover;" />
                            @else
                                <img id="preview" src="" alt="" style="width:100%; height:100%; object-fit:cover; display:none;" />
                                <span id="placeholder"><i class="fas fa-user"></i></span>
                            @endif
                        </div>
                ...
                <div class="grid-2">
                    <div class="form-group">
                        ...
                        <input type="text" name="nama" value="{{ old('nama', $instruktur->nama) }}" class="form-control" required>
                    </div>
                    <div class="form-group">
                        <label>Email</label>
                        <input type="email" name="email" value="{{ old('email', $instruktur->email) }}" class="form-control">
                    </div>
                </div>

                <div class="grid-2">
                    <div class="form-group">
                        <label>Password Akun (kosongkan jika tidak diubah)</label>
                        <input type="password" name="password" class="form-control" placeholder="Biarkan kosong jika tetap">
                    </div>
                    <div class="form-group">
                        <label>Nomor SIM</label>
                        <input type="text" name="nomor_sim" value="{{ old('nomor_sim', $instruktur->nomor_sim) }}" class="form-control">
                    </div>
                </div>
            </div>
            ...
            <div class="section">
                ...
                <div class="form-group">
                    ...
                    @if($instruktur->sertifikat)
                        <div class="current-file">
                            <i class="fas fa-check-circle"></i> 
                            Sertifikat saat ini tersedia 
                            <a href="{{ $instruktur->sertifikat }}" target="_blank" style="color: #ff7f00; text-decoration: underline; margin-left: 0.5rem;">Lihat</a>
                        </div>
                    @endif
                ...
                <div class="form-group" style="margin-top: 1.5rem;">
                    ...
                    <div class="radio-group">
                        @php $aktif = old('status_aktif', $instruktur->status_aktif ? '1':'0'); @endphp
