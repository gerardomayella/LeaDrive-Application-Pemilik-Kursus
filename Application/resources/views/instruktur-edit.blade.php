            ...
            <form method="POST" action="{{ route('instruktur.update', $instruktur->id_instruktur) }}" enctype="multipart/form-data">
                ...
                <div class="grid">
                    <div class="field">
                        ...
                        <input type="text" name="nama" value="{{ old('nama', $instruktur->nama) }}" required>
                    </div>
                    <div class="field">
                        <label class="label">Email</label>
                        <input type="email" name="email" value="{{ old('email', $instruktur->email) }}">
                    </div>
                </div>

                <div class="grid" style="margin-top:12px;">
                    <div class="field">
                        <label class="label">Password Akun (kosongkan jika tidak diubah)</label>
                        <input type="password" name="password">
                    </div>
                    <div class="field">
                        <label class="label">Nomor SIM</label>
                        <input type="text" name="nomor_sim" value="{{ old('nomor_sim', $instruktur->nomor_sim) }}">
                    </div>
                </div>
                ...
                <div class="section">
                    ...
                    <div class="field">
                        ...
                        @if($instruktur->sertifikat)
                            <div class="help">Sertifikat saat ini: <a href="{{ $instruktur->sertifikat }}" target="_blank">Lihat</a></div>
                        @endif
