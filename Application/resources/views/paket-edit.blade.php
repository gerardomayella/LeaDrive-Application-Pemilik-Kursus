...
<div class="page-container">
    <div class="form-card">
        <div class="form-header">
            <h1 class="form-title">Edit Paket Kursus</h1>
            <p class="form-subtitle">Perbarui informasi paket kursus</p>
        </div>
            ...
            <div class="section">
                ...
                <div class="grid-2">
                    <div class="form-group">
                        ...
                        <input type="number" name="harga" min="0" step="1000" value="{{ old('harga', $paket->harga) }}" class="form-control" required>
                    </div>
                    <div class="form-group">
                        <label>Durasi Total (Jam) *</label>
                        <input type="number" name="durasi_jam" min="1" step="1" value="{{ old('durasi_jam', $paket->durasi_jam) }}" class="form-control" required>
                    </div>
                </div>
